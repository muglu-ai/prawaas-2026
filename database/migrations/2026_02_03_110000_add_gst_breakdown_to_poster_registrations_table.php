...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('poster_registrations', function (Blueprint $table) {
            ...
            // Add lead author CV fields
            if (!Schema::hasColumn('poster_registrations', 'lead_auth_cv_path')) {
                $table->string('lead_auth_cv_path')->nullable()->after('extended_abstract_original_name');
            }
            if (!Schema::hasColumn('poster_registrations', 'lead_auth_cv_original_name')) {
            ...
            if (!Schema::hasColumn('poster_registrations', 'gst_required')) {
                $table->enum('gst_required', ['0', '1'])->default('1')->after('status');
            }
