...
function initNavs() {
    total.forEach(function (l, e) {
        var s = document.createElement("div"), t = l.querySelector(".nav-link.active").cloneNode(),
        ...
        if (a) {
            var n = Array.from(a.closest("ul").children), t = n.indexOf(a) + 1;
            let e = 0;
...
function darkMode(e) {
    var t = document.getElementsByTagName("body")[0], a = document.querySelectorAll("div:not(.sidenav) > hr"),
        ...
        d = document.querySelectorAll("a.nav-link.text-dark"), c = document.querySelectorAll("a.nav-link.text-white"),
        u = document.querySelectorAll(".text-secondary"), m = document.querySelectorAll(".bg-gray-100"),
        ...
        v = document.querySelectorAll(".card.border"), y = document.querySelectorAll(".card.border.border-dark"),
        p = document.querySelectorAll(".main-content .container-fluid .card"), b = document.querySelectorAll("g"),
...
window.addEventListener("resize", navbarColorOnResize), window.addEventListener("resize", sidenavTypeOnResize), window.addEventListener("load", sidenavTypeOnResize), window.onload = function () {
    ...
    for (var a = document.querySelectorAll(".btn"), t = 0; t < a.length; t++) a[t].addEventListener("click", function (e) {
        var t = e.target, a = t.querySelector(".ripple");
...
let form = document.getElementById("form"), username = document.getElementById("username"),
...
var material = {
    initFullCalendar: function () {
        ...
        if ("basic" == e) Swal.mixin({customClass: {confirmButton: "btn bg-gradient-info"}}).fire({title: "Sweet!"}); else if ("title-and-text" == e) Swal.mixin({
            customClass: {
