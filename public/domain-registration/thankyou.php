...
<div class="text-center">
    ...
    <p class="lead mb-4">Your registration for "Partner with US" has been submitted successfully.</p>
    ...
    <div class="card mb-4" style="text-align: left;">
        ...
        <div class="card-body">
            ...
            <p><strong>Mobile:</strong> <?php echo htmlspecialchars($data['mobile'] ?? ('+' . $data['mobile_country_code'] . ' ' . $data['mobile_number'])); ?></p>
