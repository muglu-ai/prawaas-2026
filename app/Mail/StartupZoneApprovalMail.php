...
class StartupZoneApprovalMail extends Mailable
{
     ...
     */
    public function __construct(Application $application, Invoice $invoice, EventContact $contact = null)
    {
    ...
    {
        return new Content(
            view: 'emails.startup-zone-approval',
            with: [
