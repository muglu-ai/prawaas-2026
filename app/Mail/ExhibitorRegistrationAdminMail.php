...
class ExhibitorRegistrationAdminMail extends Mailable
{
     ...
     */
    public function __construct(Application $application, EventContact $contact = null)
    {
        ...
        $this->invoice = Invoice::where('application_id', $application->id)->first();
    ...
    {
        $subject = config('constants.EVENT_NAME') . ' ' . config('constants.EVENT_YEAR') . ' - New Exhibitor Registration Application Submitted';
    ...
    {
        return new Content(
            view: 'emails.exhibitor-registration-admin-notification',
            with: [
