            ...
            <td>
                <div role="article" aria-label="{{ config('constants.EVENT_NAME') }} Exhibitor Credentials" style="max-width: 700px; margin: 24px auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 6px 20px rgba(16, 24, 40, 0.08);">
                    ...
                    <div style="padding: 28px;">
                        ...
                        <p style="margin: 0 0 16px 0; line-height: 1.45; color: #334155;">Greetings from <strong>{{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}</strong>!</p>
                        ...
                        <ul style="margin: 0 0 16px 0; line-height: 1.45; color: #334155; padding-left: 20px;">
                            <li>
                        ...
                        <div role="group" aria-label="Login credentials" style="background: #f8fafc; padding: 16px; border-radius: 6px; margin: 16px 0; font-family: monospace; color: #0f172a;">
                            <h3 style="margin: 0 0 12px 0; color: #0f172a;">Exhibitor Portal Details: </h3>
                        ...
                        <div style="font-size: 13px; color: #475569;">For <b>technical assistance</b>, please contact our support team at <a href="mailto:info@interlinks.in" style="color: #1a73e8; text-decoration: none;">info@interlinks.in</a>.<br>For <b>general queries</b>, write to us at <a href="mailto:enquiry@bengalurutechsummit.com" style="color: #1a73e8; text-decoration: none;">enquiry@bengalurutechsummit.com</a>.
                        </div>
                        <br>

                        <p style="margin: 0 0 16px 0; line-height: 1.45; color: #334155;">We look forward to your active participation and wish you success at <strong>{{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}</strong>!</p>
