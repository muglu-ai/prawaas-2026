            ...
            <tr>
                <td style="padding: 0; width: 100%;">
                    ...
                    <div style="border-bottom: 2px solid #e0e0e0;">
                        <img src="{{ config('constants.EMAILER_HEADER_LOGO') }}" alt="{{ config('constants.EVENT_NAME') }}" style="max-width: 100%; width: 100%; height: auto; display: block; border: 0; vertical-align: bottom;">
                    </div>
                    @endif
                </td>
            </tr>
