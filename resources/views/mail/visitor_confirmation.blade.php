                                            ...
                                            <tr>
                                                ...
                                                <table cellpadding="4" cellspacing="0" border="1" style="border-collapse: collapse; margin-top: 6px; margin-bottom: 10px; font-size: 15px; color: #333;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 2px 6px; font-size: 12px;">10:00 AM – 6:00 PM</td>
                                                        <td style="padding: 2px 6px; font-size: 12px;">10:00 AM – 6:00 PM</td>
                                                        <td style="padding: 2px 6px; font-size: 12px;">10:00 AM – 5:00 PM</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 2px 8px; font-weight: 500; font-size: 13px;">Conference</td>
                                                        <td style="padding: 2px 6px; font-size: 12px;">9:00 AM – 6:00 PM</td>
                                                        <td style="padding: 2px 6px; font-size: 12px;">9:00 AM – 6:00 PM</td>
                                                        <td style="padding: 2px 6px; font-size: 12px;">9:00 AM – 6:00 PM</td>
                                                    </tr>
                                                </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td style="text-align: right; vertical-align: middle; white-space: nowrap;">
                                        <a href="{{ route('exhibitor.pdf', ['id' => $data['unique_id']]) }}"
