                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="w-50">
                            ...
                            <p class="text-sm mb-0">
                                Application No: <b>241342</b> from <b>23.02.2021</b>
                            </p>
{{--                            <p class="text-sm">--}}
{{--                                Code: <b>KF332</b>--}}
{{--                            </p>--}}
...
{{--                                </div>--}}
                                <div>
                                    <h6 class="text-lg mb-0 mt-2">SCI Knowledge Interlinks</h6>
                                    <span class="mb-2 text-xs">Type of Business: <span class="text-dark font-weight-bold ms-2">Manufacturer,Importer</span></span><br>
                                    <span class="mb-2 text-xs">Product Category: <span class="text-dark font-weight-bold ms-2">IT</span></span><br>
                                    <span class="mb-2 text-xs">Sector: <span class="text-dark font-weight-bold ms-2">Education Institutes, Dealers / Retailers</span></span>
                                    <br>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="mb-2 text-xs">Stall Category: <span class="text-dark font-weight-bold ms-2">Shell Scheme</span></span>
                                    <span class="mb-2 text-xs">Booth Size: <span class="text-dark ms-2 font-weight-bold">12 SQM</span></span>
                            ...
                            <ul class="list-group">
                                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-2 font-weight-bold"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aac5c6c3dccfd8eac8dfd8d8c3dec584c9c5c7">[email&#160;protected]</a></span></span>
                                        <span class="text-xs">VAT Number: <span class="text-dark ms-2 font-weight-bold">FRB1235476</span></span>
                                    </div>
                                </li>
                            </ul>
