    ...
    <div class="container-fluid py-2">
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="text-end">
                                ...
                                @if (
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        onclick="openInviteModal('{{ $slug }}')">Invite</button>
                                    @if ($slug != 'Inaugural Passes')
                    ...
                    @if($extractedData->where('token', '!=', null)->count() > 0)
                                ...
                                @foreach ($extractedData as $item)
                                    <tr>
                                        <td class="text-sm font-weight-normal">
                                            ...
                                            @else
                                                @if (!empty($item['token']))
                                                    <a href="/invited/inaugural/{{ $item['token'] }}/" target="_blank" class="invite-link">📧 Invite Link</a>
                                                @else
                                                    N/A
                                                @endif
                                            @endif
                                        </td>
                                        <td class="text-sm font-weight-normal">@if (!empty($item['token']))
                                            <a href="/invited/inaugural/{{ $item['token'] }}/" target="_blank" class="invite-link">{{ $item['email'] }}</a>
                                        @else
                                            {{ $item['email'] }}
                                        @endif
                                    </td>
        ...
        @if ($slug == 'Inaugural Passes')
            <div class="alert alert-warning mt-3" role="alert">
                ...
                confirmation and will be informed separately from 1st week of August onwards.
            </div>
        @endif
