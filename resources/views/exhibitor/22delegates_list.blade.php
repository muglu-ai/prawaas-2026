                    ...
                    <div class="table-responsive">
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" data-sort="role">User Type</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#addForm").on("submit", function (e) {
                ...
                var nationalNumber = iti.getNumber(intlTelInputUtils.numberFormat.NATIONAL); // Get national number format

                // Remove spaces and leading zeros from national number
                nationalNumber = nationalNumber.replace(/\s/g, '').replace(/^0+/, '');

                // Concatenate with country code
                var formattedNumber = "+" + iti.getSelectedCountryData().dialCode + nationalNumber;
                ...
                $("#fullPhoneNumber").val(formattedNumber); // Store formatted number

                //set the value of the phone input to the formatted number
                $("#phone").val(formattedNumber);

                // Debugging
                console.log("Final Phone Number:", formattedNumber);
            });
        });
    </script>
