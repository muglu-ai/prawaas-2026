                    ...
                    <div class="table-responsive">
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" data-sort="created_at">Organisation Name</th>
{{--                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Status </th>--}}
                            ...
                            @foreach($extractedData as $item)
                                <tr>
                                    ...
                                    <td class="text-sm font-weight-normal">{{ $item['organisation_name'] ?: $companyName }}</td>
{{--                                    <td class="text-sm font-weight-normal">--}}
{{--                                    @php--}}
{{--                                    if ($item['token'] != null) {--}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="inviteModalLabel">Invite {{$slug}}</h5>
                ...
                <div class="modal-body">
                    <form id="addForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="organisationName" name="organisationName" value="{{$companyName}}" required>
                        </div>
                        <div class="mb-3">
        ...
        $(document).ready(function () {
            ...
            var iti = window.intlTelInput(input, {
                ...
                geoIpLookup: function (callback) {
                    $.get("https://ipinfo.io", function () {}, "jsonp").always(function (resp) {
                        var countryCode = resp && resp.country ? resp.country : "in"; // Default to 'IN' if no country code found
            ...
            $("#addForm").on("submit", function (event) {
                ...
                const formData = {
                    ...
                    organisationName: document.getElementById('organisationName').value // Uncomment if needed
                };
