                                                            ...
                                                            function loadStates(countryId, selectedStateId = null) {
                                                                if (countryId) {
                                                                    ...
                                                                    if (countryId === '101' || countryId === '351') {
                                                                        console.log('gst 1', gst_compliance.value);
                                                        ...
                                                        $(document).ready(function () {
                                                            function loadStates(countryId, selectedStateId = null) {
                                                                if (countryId) {
                                                                    ...
                                                                    if (countryId === '101' || countryId === '351') {
                                                                        console.log('gst 2', gst_compliance.value);
                                                                        gst_india.style.display = 'flex';
                                                                        divform.style.height = '1980px';
                                                                        form_step.style.setProperty('height', '1980px', 'important');
                                                        ...
                                                        $(document).ready(function () {
                                                            function loadStates(countryId, selectedStateId = null) {
                                                                if (countryId) {
                                                                    ...
                                                                    if (countryId === '101' || countryId === '351') {
                                                                        console.log('gst 3', gst_compliance.value);
                                                                        gst_india.style.display = 'flex';
                                                                        divform.style.height = '1980px';
                                                                        form_step.style.setProperty('height', '1980px', 'important');
                                                                        gstNo.required = true;
...
{{--                                                    <option value disabled selected>Select GST Compliance</option>--}}
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12 mt-3">
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    <input class="multisteps-form__input form-control" type="text"
                                                           ...
                                                           {{ $isDisabled }} oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('Please enter a valid GST number')" onfocus="this.setCustomValidity('')">
                                                </div>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12 mt-3">
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    <input class="multisteps-form__input form-control" type="text"
                                                           ...
                                                           oninvalid="this.setCustomValidity('Please enter a valid PAN Number')" onfocus="this.setCustomValidity('')"
                                                           {{ $isDisabled }}>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12 mt-3">
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    <input class="multisteps-form__input form-control" type="text"
                                                           ...
                                                           oninput="setCustomValidity('')"
                                                           oninvalid="this.setCustomValidity('Please enter a valid TAN Number (e.g., ABCD12345E)')"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12 col-lg-12 col-md-12">
                                                <div class="col-md-12 d-flex mt-4 pe-5  ">
                                                    ...
                                                    @else
                                                        <button
                                                            class="btn btn-info ms-auto mb-2 w-fixed h-fixed  js-btn-next"
                                                            type="submit">
                                                            Submit
                                                        </button>
                                                    @endif
    ...
    <script>
        ...
        function loadBillingStates(countryId, selectedStateId = null) {
            if (countryId) {
                console.log('Selected billing country ID:', countryId);
                const divform = document.getElementById('card-body');
                const form_step = document.getElementById('step1');
                const gst_india = document.getElementById('gst_india');
                const gst_compliance = document.getElementById('choices-sizes');
                ...
                if (countryId === '101' || countryId === '351') {
                    console.log('gst 4', gst_compliance.value);
                    gst_india.style.display = 'flex';
                    divform.style.height = '1980px';
                    form_step.style.setProperty('height', '1980px', 'important');
                    gst_compliance.required = true;
                } else {
                    console.log(gst_compliance.value);
                    gst_india.style.display = 'none';
                    divform.style.setProperty('height', '1900px', 'important');
                    form_step.style.setProperty('height', '1900px', 'important');
                    gst_compliance.required = false;
