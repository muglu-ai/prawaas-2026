                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="col-12 col-sm-3 ms-0">
                                                ...
                                                <select class=" form-select form-select-lg mb-3 text-dark dropdown "
                                                    ...
                                                    @foreach($countries as $country)
                                                        <option class="text-sm text-dark" value="{{ $country->id }}"
                                                           {{ (isset($application) && $application->billing_country_id == $country->id) || (auth()->user()->id == 72 || auth()->user()->id == 218) && $country->id == 448 ? 'selected' : '' }}>
                                                            {{ $country->name }}
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    @elseif(auth()->user()->id == 72 || 218)
                                                        ...
                                                        <select
                                                            ...
                                                            required
                                                            {{ $isDisabled }} onchange="validateState(this)">
                                                            <option value="448">Central Singapore</option>
                                                            <option value="448">North East</option>
                                                            <option value="448">North West</option>
                                                            <option value="448">South East</option>
                                                            <option value="448">South West</option>
                                                        </select>
