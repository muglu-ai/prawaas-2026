            ...
            <div class="col-lg-12">
                ...
                <div class="container">
                    <div class="row mb-4 align-items-center">
                        ...
                        <div class="col-md-6 d-flex flex-column flex-md-row justify-content-md-end align-items-md-center gap-2 gap-md-3">
                            ...
                            @if ($category->name !== 'Titmle Sponsors')
                                <div class="collapse" id="category-{{ $category->id }}">
                                    ...
                                    @if ($category->name === 'Conference Sponsorship')
                                        <div class="alert alert-info" role="alert">
                                            <h4 class="mb-2"> *Please ensure that the presentation content complies with program topic and direction. 
                                                More than 80% of the presentation should be about technology insight, not product information.
                                                Organizer reserves the right to see the presentation beforehand to ensure the program quality.</h4>
                                        </div>
                                    @endif
                                </div>
                            @endif
...
document.addEventListener('DOMContentLoaded', function () {
    const hasBaseFromBackend = window.existingBaseConferenceItemIds && window.existingBaseConferenceItemIds.length > 0;
