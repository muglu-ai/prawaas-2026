        ...
        <div class="row min-vh-120 mt-5">
                                ...
                                <div class="multisteps-form__content">
                                    <div class="container">
                                                ...
                                                <select class="form-select form-select-lg mb-3 text-dark dropdown"
                                                    ...
                                                    @foreach($countries as $country)
                                                        <option class="text-sm text-dark" value="{{ $country->id }}"
                                                            {{ isset($application) && $application->country_name == $country->id ? 'selected' : '' }}>
                                                            {{ $country->name }}
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <script>
                                                        $(document).ready(function () {
                                                            ...
                                                            var selectedCountryId = "{{$application->country_name ?? ''}}";
                                        ...
                                        <div class="text-xxs font-weight-bold text-dark ms-2 " style="font-size: 7rem;">
                                            <p class="font-weight-bold text-lg black-label" style="font-size: 7rem;">Event Contact
                                        ...
                                        <div class="text-xxs font-weight-bold text-dark ms-2 " style="font-size: 7rem;">
                                            <p class="font-weight-bold text-lg black-label mt-4" style="font-size: 7rem;">Event Contact
                                        ...
                                        <div class="row mt-4 ms-0">
                                            ...
                                            <div class="col-md-4 col-sm-4  mt-sm-0">
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <input class="multisteps-form__input form-control mt-2" type="text"
                                                           name="sec_event_contact_first_name" id="sec_event_contact_first_name"
                                        ...
                                        <div class="row mt-5 ms-0">
                                            <div class="col-12 col-sm-4">
                                                <label for="designation" class="form-label red-label ">Job Title </label>
                                                <div class="input-group input-group-dynamic">
                                            ...
                                            <div class="col-12 col-sm-4 mt-3 mt-sm-0">
                                                <label for="contactPhone" class="form-label red-label ">Contact Number</label>
                                                <div class="input-group input-group-dynamic">
                                                    <select class="form-control" id="choices-languages"
                                                            name="sec_contactPhone_code" style="max-width: 80px;">
                                                        @foreach($countries->unique('code') as $country)
                                                            <option value="{{ $country->code }}"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="">
                                                            <p class="ms-1 text-lg black-label red-label">Billing Details:</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="col-12 col-sm-3 mt-3 mt-sm-0">
                                                ...
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <script>
                                                        document.addEventListener("DOMContentLoaded", function () {
                                                            let billingCountry = document.getElementById("country"); // Billing country dropdown
                                        ...
                                        <div class="row mt-2 " id="gst_india">
                                            <div class="col-md-3 col-sm-6 col-12 mt-3">
                                                ...
                                                <select class="multisteps-form__input form-select" name="gst_compliance"
                                                        id="choices-sizes"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12 d-flex mt-4 pe-5  ">
                                                ...
                                                @else
                                                    <button
                                                        class="btn btn-info ms-auto mb-0 w-fixed h-fixed  js-btn-next"
                                                        type="submit">
                                                        Submit
                                                    </button>
                                                @endif
            ...
            <script>
                ...
                function loadBillingStates(countryId, selectedStateId = null) {
                    if (countryId) {
                        //so if the country id is country === '101' || country === '351' then show the gst_india div
                        if (countryId === '101' || countryId === '351') {
                            document.getElementById('gst_india').style.display = 'flex';
                        } else {
                            document.getElementById('gst_india').style.display = 'none';
                        }
                        $.ajax({
                            url: "{{ route('get.states') }}",
                            type: "POST",
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    const gst_compliance = document.getElementsByName('gst_compliance')[0];
