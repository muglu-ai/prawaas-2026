  ...
  <div class="card thank-you-card text-center">
    ...
    <div class="card-header">
      <div class="d-flex justify-content-center align-items-center mb-4 gap-3">
        ...
        <img src="{{ asset('asset/img/logos/DIC_Logo.webp') }}" width="120" alt="Digital India Logo" class="logo4">
      ...
      <p class="lead text-muted">Your registration for SEMICON® India 2025 is confirmed.</p>
    </div>
...
{{--
      <div class="alert alert-info d-flex align-items-center mt-3" role="alert">
        ...
        <span>
          <strong>Note:</strong> Kindly note that participation (in-person) in the Inaugural event is subject to final confirmation based on availability and will be informed separately.
        </span>
      </div>
--}}
      <div class="alert alert-warning d-flex align-items-start mt-3" role="alert" style="background: #fff8e1;">
  <!-- <span class="me-3 mt-1">
    <i class="fa-brands fa-youtube" style="color: #FF0000; font-size: 2rem;"></i>
  </span> -->
  <div class="text-start">
    <strong class="d-block mb-1" style="color: #795548;">Registrations for the Inaugural Session are now closed.</strong>
    <span class="text-dark">
      You can still watch the session live on our official YouTube channel through the links given below:
      <br>
     <a href="https://www.youtube.com/@IndiaSemiconductorMission/streams" target="_blank"
   class="fw-bold d-inline-flex align-items-center mt-2"
   style="font-size: 1.15rem; color: inherit; text-decoration: none;">
  <i class="fa-brands fa-youtube me-2" style="color: #FF0000; font-size: 1.5rem; text-decoration: none;"></i>
  <span style="color: #0056b3; text-decoration: underline;">@IndiaSemiconductorMission/streams</span>
      ...
      {{--
      <!-- Interactive Registration ID -->
      <div class="my-4">
        <label for="uniqueIdInput" class="form-label fw-bold">Your Unique Registration ID:</label>
        <div class="input-group">
          <input type="text" id="uniqueIdInput" class="form-control form-control-lg registration-id-wrapper" value="{{ $attendee->unique_id }}" readonly>
  ...
  {{--
      <div class="my-4">
        <h5 class="fw-normal">Your QR Code for Event Check-in</h5>
        <img src="{{ $qrCode }}" class="img-thumbnail" alt="Your Registration QR Code" style="max-width: 200px;">
  <p class="form-text mt-2">Simply scan this at the venue for quick entry.</p>
  </div>
