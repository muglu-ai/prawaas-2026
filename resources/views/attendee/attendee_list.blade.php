        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-end mb-3">
                                        <form method="GET" action="{{ route('export.list') }}"
                ...
                <form id="mass-approve-form" method="POST" action="{{ route('attendees.mass.approve') }}">
                    @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <a href="{{ route('visitor.pdf', $attendee->unique_id) }}"
                                                        ...
                                                        @if ($attendee->inauguralConfirmation == 0 && $attendee->inaugural_session == 1)
                                                            <form action="{{ route('approve.attendee') }}" method="POST"
                                                                ...
                                                                <button type="submit" class="btn btn-sm"
                                                                    ...
                                                                    <i class="fas fa-check"></i> Click Here to<br>Approve
                                                                    for
                                                                    Inaugural
                                                                </button>
                                                            </form>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center text-muted py-4">No attendees found.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
