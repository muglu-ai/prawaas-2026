                    ...
                    @if($application->submission_status == "approved")
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <p class="ms-3 ms-lg-5 me-3 me-lg-5">
                                ...
                                @if(isset($application->invoice))
                                    @php
                                        $status = strtolower($application->invoice->payment_status);
                                        $badgeClass = 'badge rounded-pill bg-light text-dark border border-secondary';
                                        $status = strtolower($application->invoice->payment_status ?? 'pending');
                                        switch ($status) {
                                            case 'paid':
                                    ...
                                    @endphp
                                    <span class="{{ $badgeClass }}">{{ ucfirst($application->invoice->payment_status) }}</span>
                                @else
                                    <span class="badge bg-danger">Pending</span>
                                @endif
                                (Once payment status is updated, you will get the dashboard access to complete next action items.)
                                <br>
                                ...
                                We look forward to completing the onboarding process once the payment is received.
                            </p>
                        ...
                        <div class="table table-responsive">
                            <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-left text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        Approved <br> Booth Size
                                    </th>
                                    <th class="text-left text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        Allocated <br>Booth Number
                                    </th>
                                    <th class="text-left text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        Billing Company
                                    </th>
...
{{--                                    <td class="text-center">{{$invoice->id}}</td>--}}
                                    <td class="text-center">{{ \Carbon\Carbon::parse($application->approved_date)->format('Y-m-d') }}</td>
...
{{--                                            </button>--}}
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            @if (isset($application->submission_status) && $application->submission_status != 'initiated')
                                <a href="{{ route('download.application.form')}}" class="btn btn-link">Download Application Form</a>
                            @endif
                            <a href="{{ route('terms') }}" class="btn btn-link">VIEW TERMS & CONDITION</a>
                            </div>
                        </div>
