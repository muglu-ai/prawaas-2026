<div class="modal fade" id="addSectorModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('super-admin.sectors.add') }}">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_active" id="sectorActive" checked>
                        <label class="form-check-label" for="sectorActive">Active</label>
                    </div>
                </div>
