<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    {{-- <div class="sidenav-header">
        ...
        <a class="navbar-brand px-4 py-3 m-0" href="#">
            ...
            <br>
            <span class="ms-1 text-sm text-dark">SEMICON India 2025</span>
        </a>
    </div> --}}
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark " href="{{ route('dashboard.co-exhibitor') }}">
                    <i class="material-symbols-rounded opacity-5">space_dashboard</i>
                    <span class="sidenav-mini-icon"> </span>
                    <span class="sidenav-normal ps-1"> Dashboard </span>
                </a>
            </li>

            @php 
                use App\Models\CoExhibitor;
                $coExhibitor = CoExhibitor::where('user_id', Auth::id())->first();
            @endphp

            @if(isset($coExhibitor) && $coExhibitor->purchase_allowed == 1)
            <a data-bs-toggle="collapse" href="#requirements" class="nav-link text-dark " aria-controls="pagesExamples"
