...
<div class="container-fluid py-4">
    ...
    <span>
        ...
        <a href="https://www.youtube.com/@IndiaSemiconductorMission/streams" target="_blank" style="color: #0056b3; text-decoration: underline;">
            <i class="fab fa-youtube" style="color: #ff0000; font-size: 1.2em; vertical-align: middle;"></i>
            YouTube: https://www.youtube.com/@IndiaSemiconductorMission/streams
        </a>
    </span>
</div> 
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    
                    <h6>Inaugural Passes</h6>
                    <div>
                        {{-- <button type="button" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#addExhibitorModal">
                            <i class="fas fa-user-plus me-2"></i>Add Inaugural Pass
                        </button> 
...
{{-- write js to send ajax request to exhibition.invite with post method with form name invite_type as delegate and email as email --}}
<script>
document.addEventListener('DOMContentLoaded', function() {
