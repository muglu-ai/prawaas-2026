            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6 class="text-md mb-0">Invoices</h6>
                        <a href="{{ route('export.stall_invoices') }}" class="btn btn-success mb-3">
                            <i class="fas fa-download"></i> Export Stall Updated Invoices
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id="datatable-basic">
                                <thead class="table-dark">
                                    <tr>
                                        <th scope="col" class=" text-uppercase text-white ">Company Name /Billing Company</th>
                                            ...
                                            <tr class="text-start">
                                                    ...
                                                    <div class="mb-0 text-md text-dark text-start" style="word-break: break-word; overflow-wrap: break-word; white-space: normal; max-width: 150px;">
                                                        <a class="text-md text-info" href="{{ route('application.view', ['application_id' => $application->application_id]) }}">
                                                            {{ $application->billingDetail->billing_company ?? 'N/A' }}
                                                             <span class="text-muted">({{ $application->company_name }})</span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-dark text-md">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                            ...
                                                            data-currency="INR">
                                                        Update Payment Info and Onboard Exhibitor
                                                    </button>
                                                </td>
                                            </tr>
                                        @endforeach
