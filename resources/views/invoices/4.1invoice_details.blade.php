                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <p class="mb-1"><strong>Surcharge @ {{ $invoice->surChargepercentage }}%:</strong></p>
                                                @endif
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if($invoice->surCharge > 0)
                                                <p class="mb-1 text-end">INR {{ number_format($invoice->surCharge ?? 0, 2) }}</p>
                                                @endif
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @php
                                            try {
                                                ...
                                                $remainingAmount = ($invoice->total_final_price ?? 0) - $totalPaid;
