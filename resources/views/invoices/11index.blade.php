...
{{--                <p class="mb-4 text-dark text-md">--}}
...
{{--                                            <td>{{ $application->billingDetail->billing_company ?? 'N/A' }}</td>--}}
                                            ...
                                            <td class="text-dark text-md"> {{$invoice->currency}} {{  number_format($invoice->amount, 2) }}</td>
                                            <td class="text-dark text-md"> {{$invoice->currency}} {{  number_format($invoice->amount_paid, 2) }}</td>
                                            <td class="text-dark text-md">
...
{{--                                                <a href="{{ route('invoice.show', ['id' => $invoice->invoice_no]) }}" class="btn btn-info text-uppercase">View Receipt</a>--}}
                                                <button type="button" class="btn btn-primary"
                                                        ...
                                                        data-currency="{{ $application->payment_currency }}">
                        ...
                        <div class="modal-body">
                            <form id="uploadReceiptForm" action="{{ route('upload.receipt') }}" method="POST"
                                ...
                                <input type="text" class="form-control" id="currency" name="currency"
                                       value="{{ $application->payment_currency }}" readonly>
                                                    </div>
