...
@section('title', 'Create Ticket Type - ' . $event->event_name)
    ...
    <div class="ticket-form-card">
        <div class="ticket-form-header">
            <h4>
                ...
                Create New Ticket Type - {{ $event->event_name }}
            </h4>
        ...
        <div class="ticket-form-body">
            ...
            <form action="{{ route('admin.tickets.events.ticket-types.store', $event->id) }}" method="POST">
                @csrf
