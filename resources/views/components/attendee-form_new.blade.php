        ...
        <div class="attendee-step attendee-step-1" id="attendee-step-1-{{ $index }}">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="attendees[{{ $index }}][state]" class="form-control"
                    ...
                    <div class="custom-dropdown-container">
                        <div class="custom-dropdown" id="event_days_dropdown_{{ $index }}">
                            <div class="dropdown-selected" onclick="toggleCustomDropdown(this)">
                                ...
                                <span class="selected-text">Select event days...</span>
                                <i class="dropdown-arrow">▼</i>
                            </div>
                            <div class="dropdown-options" id="event_days_options_{{ $index }}">
                                @foreach ($eventOptions as $val => $label)
                                    <label class="dropdown-option">
                                        <input type="checkbox" name="attendees[{{ $index }}][event_days][]" 
                                               value="{{ $val }}"
                                               data-label="{{ $label }}"
                                               {{ !empty($data['event_days']) && in_array($val, $data['event_days']) ? 'checked' : '' }}
                    ...
                    <div class="custom-dropdown-container">
                        <div class="custom-dropdown" id="business_nature_dropdown_{{ $index }}">
                            <div class="dropdown-selected" onclick="toggleCustomDropdown(this)">
                                ...
                                <span class="selected-text">Select business nature...</span>
                                <i class="dropdown-arrow">▼</i>
                            </div>
                    ...
                    <div class="custom-dropdown-container">
                        <div class="custom-dropdown" id="purpose_dropdown_{{ $index }}">
                            <div class="dropdown-selected" onclick="toggleCustomDropdown(this)">
                                ...
                                <span class="selected-text">Select purpose of visit...</span>
                                <i class="dropdown-arrow">▼</i>
                            </div>
                    ...
                    <div class="custom-dropdown-container">
                        <div class="custom-dropdown" id="product_categories_dropdown_{{ $index }}">
                            <div class="dropdown-selected" onclick="toggleCustomDropdown(this)">
                                ...
                                <span class="selected-text">Select product categories...</span>
                                <i class="dropdown-arrow">▼</i>
                            </div>
    ...
    <script>
        class AttendeeFormValidator {
            ...
            updateCategoryDependentFields() {
                ...
                const businessNature = document.getElementById(`business_nature_${this.index}`);
                if (businessNature) {
                    businessNature.required = isBusinessRequired;
                }

                // Product Categories required logic
                const products = document.getElementById(`product_categories_${this.index}`);
                if (products) {
            ...
            updateRequiredLabels(isRequired) {
                // Update "The purpose of your visits:"
                const purposeLabel = document.querySelector(`label[for="purpose_${this.index}_visit"]`) ||
                    Array.from(document.querySelectorAll('.col-md-12 label'))
                        .find(l => l.textContent.trim().startsWith('The purpose of your visits:'));
                if (purposeLabel) {
                    purposeLabel.innerHTML = `The purpose of your visits: ${isRequired ? '<span class="important">*</span>' : ''}`;
                }

                // Update "Product Categories of your interest:"
                const productLabel = document.querySelector(`label[for="product_categories_${this.index}"]`) ||
                    Array.from(document.querySelectorAll('.col-md-12 label'))
                        .find(l => l.textContent.trim().startsWith('Product Categories of your interest:'));
                if (productLabel) {
                    productLabel.innerHTML = `Product Categories of your interest: ${isRequired ? '<span class="important">*</span>' : ''}`;
                }

                // Update "Nature of your Business:"
                const businessLabel = document.querySelector(`label[for="business_nature_${this.index}"]`) ||
                    Array.from(document.querySelectorAll('.col-md-12 label'))
                        .find(l => l.textContent.trim().startsWith('Nature of your Business:'));
                if (businessLabel) {
                    businessLabel.innerHTML = `Nature of your Business: ${isRequired ? '<span class="important">*</span>' : ''}`;
                }
            }
